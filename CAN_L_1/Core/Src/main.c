...
//	     readValue = HAL_ADC_GetValue(&hadc1);
	 // SSD1306_Clear();
	  ...
	  //SSD1306_Puts ("OLED while1 Test", &Font_11x18, 1);
	  SSD1306_UpdateScreen();
...
//	     txMessage.frame.data6 = '0';//readValue & 0xff;
//	     txMessage.frame.data7 = '0';//readValue >> 8;
...
//	         SSD1306_Puts (snum, &Font_11x18, 1);
	         //SSD1306_UpdateScreen();
	     //SSD1306_Puts ("OLED while Test", &Font_11x18, 1);
	     char sstr[6];
//
	     if(CANSPI_Receive(&rxMessage))
	     {
	         uint8_t *dataPtr = &rxMessage.frame.data0;
	         ...
	         sstr[rxMessage.frame.dlc] = '\0';
	         SSD1306_UpdateScreen();
	         SSD1306_Puts ("OLED rx Test", &Font_11x18, 1);
